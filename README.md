...
1. Open the provided [ArduinoMEGA_Main.ino](/ArduinoMEGA_Main/ArduinoMEGA_Main.ino) script.
...
1. Open the provided [ArduinoUNO_SerialThruPort.ino](/ArduinoUNO_SerialThruPort/ArduinoUNO_SerialThruPort.ino) script.
...
4. Open the provided [Processing_audioGraphics.pde](/Processing_AudioGraphics/Processing_AudioGraphics.pde) sketch in Processing.
...
4. Open the provided [Max_Host.maxpat](/Max_Host) patch in Max.
